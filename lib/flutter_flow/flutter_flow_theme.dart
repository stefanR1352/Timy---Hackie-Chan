...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color thistle = const Color(0xFFCDB4DB);
  late Color fairyTale = const Color(0xFFFFC8DD);
  late Color carnationPink = const Color(0xFFFFAFCC);
  late Color uranianBlue = const Color(0xFFBDE0FE);
  late Color lightSkyBlue = const Color(0xFFA2D2FF);
}
