...
import 'ten_things_every_childwith_autism_wishes_you_knew_model.dart';
export 'ten_things_every_childwith_autism_wishes_you_knew_model.dart';

class TenThingsEveryChildwithAutismWishesYouKnewWidget extends StatefulWidget {
  const TenThingsEveryChildwithAutismWishesYouKnewWidget({super.key});

  @override
  _TenThingsEveryChildwithAutismWishesYouKnewWidgetState createState() =>
      _TenThingsEveryChildwithAutismWishesYouKnewWidgetState();
}

class _TenThingsEveryChildwithAutismWishesYouKnewWidgetState
    extends State<TenThingsEveryChildwithAutismWishesYouKnewWidget>
    with TickerProviderStateMixin {
  late TenThingsEveryChildwithAutismWishesYouKnewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => TenThingsEveryChildwithAutismWishesYouKnewModel());
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/91kr1oHWSfL._AC_UF1000,1000_QL80_.jpg',
              ).image,
            ),
          ),
