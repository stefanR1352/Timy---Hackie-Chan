...
import 'differentnotless_model.dart';
export 'differentnotless_model.dart';

class DifferentnotlessWidget extends StatefulWidget {
  const DifferentnotlessWidget({super.key});

  @override
  _DifferentnotlessWidgetState createState() => _DifferentnotlessWidgetState();
}

class _DifferentnotlessWidgetState extends State<DifferentnotlessWidget>
    with TickerProviderStateMixin {
  late DifferentnotlessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DifferentnotlessModel());
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/33182540234782.jpg',
              ).image,
            ),
          ),
          child: InkWell(
